...
all_df = pd.read_csv("https://raw.githubusercontent.com/FarizSidki/Proyek-Analisis-Data/main/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/FarizSidki/Proyek-Analisis-Data/main/dashboard/geolocation.csv')
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://raw.githubusercontent.com/FarizSidki/Proyek-Analisis-Data/main/dashboard/logo.png"
                 , width=100)
    with col3:
        st.write(' ')
...
st.write("**This dashboard provides insights into public E-Commerce data analysis**")
...
ax[0].set_title("Most sold products", loc="center", fontsize=16)
...
ax[1].set_title("Fewest products sold", loc="center", fontsize=16)
...
st.caption('Copyright (C) Fariz Sidki 2024')
